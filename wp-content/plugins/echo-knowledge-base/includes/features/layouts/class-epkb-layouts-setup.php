...
class EPKB_Layouts_Setup {
	...
	public static function is_core_layout( $layout ) {
		return $layout == EPKB_KB_Config_Layout_Basic::LAYOUT_NAME || $layout == EPKB_KB_Config_Layout_Tabs::LAYOUT_NAME || $layout == EPKB_KB_Config_Layout_Categories::LAYOUT_NAME || $layout == EPKB_KB_Config_Layout_Modular::LAYOUT_NAME;
	}
