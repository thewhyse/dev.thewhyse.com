...
class EPKB_KB_Search {
	...
	public function search_kb() {
		...
		$search_result = $kb_config['kb_main_page_layout'] == EPKB_KB_Config_Layout_Modular::LAYOUT_NAME
			? EPKB_ML_Search::get_search_results_html( $result )
			: self::get_search_results_html( $result, $search_terms, $kb_config );
	 ...
	 * @return string
	 */
	private static function get_search_results_html( $search_results, $search_terms, $kb_config ) {
