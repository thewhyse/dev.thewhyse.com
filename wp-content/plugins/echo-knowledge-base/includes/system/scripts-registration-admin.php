...
function epkb_load_admin_plugin_pages_resources() {
	...
	if ( EPKB_Utilities::get('page', '', false) == 'ep'.'kb-plugin-analytics' ) {
...
function epkb_load_editor_styles() {
	...
	$epkb_editor_params = array(
		...
		'inside_modules_editor_msg'     => __( 'Modular Layout Settings are found in the backend configurations.', 'echo-knowledge-base' ),
	);
