jQuery(document).ready(function($) {
		...
		}).always(function ()
		{
			...
			if ( msg ) {
				...
				if ( $( '.epkb-ml-search-results__no-results' ).length > 0 ) {
					$( '#epkb-ml-search-results' ).css( 'height','75px' );
				} else {
	...
	$level_1_CategoryButton.on('click', function() {
		...
		//$('.epkb-ml-1-lvl-categories-content-container' ).slideUp();
		...
		$( '.epkb-back-button' ).css( 'display' , 'none' );
		$level_2_CategoryContent.css( 'display', 'none' );
		$( '.epkb-ml-1-lvl-categories-content-container' ).css( 'display' , 'none' );


		$( '.epkb-ml-1-lvl-categories-content-container' ).slideDown();
		...
		$( '.epkb-ml-1-lvl-categories-content-container' ).addClass( 'epkb-ml-1-lvl-categories-content-container--show' );
	...
	$level_2_CategoryButton.on('click', function() {
		...
		// Show Back Button
		$( '.epkb-back-button' ).css( 'display' , 'flex' );
	...
	$('.epkb-back-button').on('click', function() {

		// Get the ID of the 1st Level Category selected
		const elementId = $( '.epkb-ml-1-lvl__cat-button--active' ).attr('id');

		// Hide Content for a better transition effect
		$( '.epkb-ml-1-lvl-categories-content-container' ).hide();
		...
		// Show Category Description / Articles
		$('.epkb-ml-1-lvl__cat-content[data-cat-content="'+elementId+'"]').addClass( 'epkb-ml-1-lvl__cat-content--active' );

		$( '.epkb-ml-1-lvl-categories-content-container' ).slideDown( 500 );
