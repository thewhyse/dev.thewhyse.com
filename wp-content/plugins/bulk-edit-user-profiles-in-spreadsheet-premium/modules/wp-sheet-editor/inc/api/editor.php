	...
	class WP_Sheet_Editor_Factory {
		...
		function get_editor_settings( $current_provider_in_page ) {
			...
			$this->texts = array(
				...
				'export_scheduled_in_popup'           => __( '<p>The export has been scheduled. You can close this popup. <a data-wpse-remodal-target="vgse_scheduled_exports_modal">View scheduled exports</a>.</p>', 'vg_sheet_editor' ),
				'import_scheduled_in_popup'           => __( '<p>The import has been scheduled. You can close this popup. <a data-wpse-remodal-target="vgse_scheduled_imports_modal">View scheduled imports</a>.</p>', 'vg_sheet_editor' ),
				'save_rows_scheduled_in_popup'        => __( '<p>The changes have been scheduled. You can close this popup. <a data-wpse-remodal-target="vgse_scheduled_save_rows_modal">View scheduled changes</a>.</p>', 'vg_sheet_editor' ),
				'bulk_edit_scheduled_in_popup'        => __( '<p>The bulk edit has been scheduled. You can close this popup. <a data-wpse-remodal-target="vgse_scheduled_bulk_edits_modal">View scheduled bulk edits</a>.</p>', 'vg_sheet_editor' ),
				'scheduled_changes_popup_modified_cells'        => __( 'Modified cells', 'vg_sheet_editor' ),
				'scheduled_export_edited_successfully'        => __( 'The export has been edited successfully', 'vg_sheet_editor' ),
				'google_sheets_modal_disconnect_warning'        => __( 'If you disconnect your Google Sheets account, all the ongoing/scheduled exports and imports between Google Sheets and WordPress will stop. Are you sure you want to disconnect the Google account?', 'vg_sheet_editor' ),
				'scheduled_bulk_edit_edited_successfully'        => __( 'The bulk edit has been edited successfully', 'vg_sheet_editor' ),
				'scheduled_import_edited_successfully'        => __( 'The import has been edited successfully', 'vg_sheet_editor' ),
