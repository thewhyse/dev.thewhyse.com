...
if ( ! function_exists( 'trx_addons_sc_tgenerator_generate_text' ) ) {
	...
	function trx_addons_sc_tgenerator_generate_text() {
		...
		$limits = (int)trx_addons_get_option( 'ai_helper_sc_tgenerator_limits' ) > 0;
		$limit_per_request = (int)trx_addons_get_option( 'ai_helper_sc_tgenerator_limit_per_request' );
		$limit_per_hour = (int)trx_addons_get_option( 'ai_helper_sc_tgenerator_limit_per_hour' );
		$limit_per_visitor = (int)trx_addons_get_option( 'ai_helper_sc_tgenerator_limit_per_visitor' );
