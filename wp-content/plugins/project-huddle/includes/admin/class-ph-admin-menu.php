...
class PH_Admin_Menu
{
	...
	public function __construct()
	{
		...
		add_action('admin_head', array($this, 'ph_hide_fs_change_plan_button'));
	...
	public function ph_hide_fs_change_plan_button() 
	{
		echo '<style>
			#fs_account #fs_account_details .fs-change-plan {
			display: none !important;
		 } 
		</style>';
	}
