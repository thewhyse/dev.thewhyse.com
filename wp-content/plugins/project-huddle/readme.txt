...
Contributors: brainstormforce, 2winfactor, freemius
...
= Version 4.5.8 - July 5th, 2023 =
- Improvement: Updated Freemius SDK to version 2.5.10

= Version 4.5.7 - May 25th, 2023 =
- Improvement: Added compatibility to WordPress version 6.2.2
- Improvement: Updated Freemius SDK to version 2.5.7

= Version 4.5.6 - October 5th, 2022 =
- Improvement: Added more plugin compatibility checks for a few security plugins on the system check panel.
- Fix: Comment links not working in Daily/Weekly summary emails.
- Fix: PHP error of call to undefined function 'is_plugin_active' in some cases.

= Version 4.5.5 - September 1st, 2022 =
- Improvement: Option to create separate folder for all ProjectHuddle uploads.
- Improvement: Added "ph.mockup.deleteAttachment.notification.learnMoreLink" JS filter to change attachment delete notification learn more link.
- Fix: Console error on Add New Website screen.
- Fix: Terms link not working when approving website.

= Version 4.5.4 - August 4th, 2022 =
- Improvement: Added compatibility to WordPress version 6.0.1.
- Improvement: Merged the copy and paste buttons into the same on website setup screen.
- Fix: Comment position issue due to incorrect element selectors.
- Fix: Duplicate activity emails are sent to task assigned user.

= Version 4.5.3 - June 27th, 2022 =
- Fix: Fixed a bug with the vendor folder that caused the plugin to not work on the admin side.

= Version 4.5.2 - June 15th, 2022 =
