			...
			Astra_Notices::add_notice(
				array(
					...
					'message'                    => sprintf(
						...
						$image_path,
						__( 'Hello! Seems like you have used ProjectHuddle to collect feedback on this website — Thanks a ton!', 'project-huddle' ),
						__( 'Could you please do us a BIG favor and give it a 5-star rating on WordPress? This would boost our motivation and help other users make a comfortable decision while choosing the ProjectHuddle.', 'project-huddle' ),
